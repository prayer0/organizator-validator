import Organizator_Validation_ItemValidationResultBuilder from 'organizator-validator/Component/Validation/ItemValidationResultBuilder';

export default class Organizator_Validation_Interpreter {
    constructor(validator, input, value, element, property) {
    ...
    validateRule(node){
        ...
        let constraint = new (this.validator.constraints[constraintName])(constraintArguments);
